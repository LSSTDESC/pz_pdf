...
Why are the odds gettig fucked up? might be the z_thru parameter.
"""

from useful_py3 import *
rolex=watch()
rolex.set()
...
import pickle
import shelve
from will_tools_py3 import *

from coetools_py3 import pause, params_cl
...
# Nope, things are still mostly bullshit! dmag are waaay off, or is that flux? that would be unhelpful....
